...
$filePath = 'C:/Users/A/Desktop/测试合同/扫描版pdf/contract_04_涪陵焦页88号平台页岩气集输工程设计_扫描版.pdf';
...
$outputDir = __DIR__ . '/output/pdf_images';
...
// 保存结果
$outputFile = __DIR__ . '/output/contract_04_full_text.md';
...
echo "=== 文本预览 ===\n";
echo str_repeat("=", 60) . "\n";
echo mb_substr($fullText, 0, 2000) . "...\n";
