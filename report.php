...
<div class="mf-panel"><div class="mf-table-wrap"><table class="mf-table mf-table--striped table-mf mf-mb-0"><thead><tr><th>合同编号</th><th>合同名称</th><th>客户名称</th><th>合同类型</th><th>截止日期</th><th>剩余天数</th><th>状态</th></tr></thead><tbody><?php foreach($rows as $r): ?><tr><td><?= e((string)$r['contract_no']) ?></td><td><?= e((string)$r['contract_name']) ?></td><td><?= e((string)$r['customer_name']) ?></td><td><?= e((string)($r['type_name']?:'-')) ?></td><td><?= e((string)$r['expiry_date']) ?></td><td><?= (int)$r['left_days'] ?></td><td><?= mf_contract_status_badge((string)$r['status']) ?></td></tr><?php endforeach; ?><?php if(!$rows): ?><tr><td colspan="7" class="mf-text-center mf-text-muted mf-p-4">暂无即将到期合同</td></tr><?php endif; ?></tbody></table></div></div>
<?php
